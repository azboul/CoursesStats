...
================================================== -->	
	    	<div class="container ">
				<div class="row formSortie">
					<div class="col-lg-12">
						<div class="panel panel-default ">
							<div class="panel-body">
								<div role="tabpanel" >
									<ul class="nav nav-pills " role="tablist">
										<li role="presentation"><a href="#AjoutSortie" aria-controls="AjoutParcours" role="tab" data-toggle="tab">Ajouter d'une sortie</a></li>
									</ul>
									<br />
									<div class="tab-content ">
										<div role="tabpanel" class="tab-pane" id="AjoutSortie">
...
================================================== -->
	    	<div class="container ">
				<div class="row formParcours">
					<div class="col-lg-12">
						<div class="panel panel-default ">
							<div class="panel-body">
								<div role="tabpanel" >
									<ul class="nav nav-pills " role="tablist">
										<li role="presentation"><a href="#AjoutParcours" aria-controls="AjoutParcours" role="tab" data-toggle="tab">Ajout d'un parcours</a></li>
									</ul>
									<br />
									<div class="tab-content ">
